...
function createData(user_name, password, role, phone, territory) {
return {
user_name, password, role, phone, territory,};
}
...
>
База пользователей
<Tooltip title="Поиск пользователя">
<IconButton>
<SearchIcon />
</IconButton>
</Tooltip>
...
const [orderBy, setOrderBy] = React.useState('password');
...
const newSelecteds = rows.map((n) => n.user_name);
...
const handleClick = (event, user_name) => {
